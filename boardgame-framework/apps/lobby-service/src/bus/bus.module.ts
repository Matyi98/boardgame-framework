...
/**
 * Wires a connected RabbitMQClient + Publisher + Consumer into the DI graph.
 * Same module pattern is duplicated (intentionally — copy-paste is fine for a
 * 4-service skeleton) in realtime-gateway and game-engine.
 */
@Global()
@Module({
  providers: [
